...
export default class Paginator extends LightningElement {
    ...
    @track ITEMS_PER_PAGE = this.pageSizeOptions[0].value;
    ...
    get MAX_ALLOWED_PAGE(){ 
        return Math.ceil(this.TOTAL_RECORDS_SIZE / this.ITEMS_PER_PAGE);
    }
    ...
    set itemsPerPage(val){
        this.ITEMS_PER_PAGE = parseInt(val, 10);
        this.renderPagesList();
    }
    ...
    handlePageSizeChange(event){
        this.ITEMS_PER_PAGE = parseInt(event.detail.value, 10);
