...
const processPastMessagesData = function (data) {
    if (data.length > 0) {
        ...
        // console.log("mobileMessagingChatComponentMessageProcessor processPastMessagesData");
...
const updateMessageMap = function (date, sobject) {
    try {
        ...
        // console.log("mobileMessagingChatComponentMessageProcessor updateMessageMap");
